...
public interface IProductShopServiceV2 {
    ProductResponse addNewProduct(ProductRequestV2 request);
    ...
    ProductResponse updateProduct(ProductRequestV2 productRequest);
