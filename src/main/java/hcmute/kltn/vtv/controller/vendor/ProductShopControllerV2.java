...
@RestController
@RequestMapping("/api/vendor/v2/product")
@RequiredArgsConstructor
public class ProductShopControllerV2 {

    @Autowired
    private IProductShopServiceV2 productService;
    @Autowired
    private final IPageService pageService;

    @PostMapping("/add")
    public ResponseEntity<ProductResponse> addNewProduct(@RequestBody ProductRequestV2 request,
    ...
    public ResponseEntity<ProductResponse> updateProduct(@PathVariable Long productId,
                                                         @RequestBody ProductRequestV2 request,
                                                         HttpServletRequest httpServletRequest) {
